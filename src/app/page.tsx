...
function HomeContent() {
  ...
  return (
    ...
    <div className="flex items-center justify-between p-4 border-b bg-white">
      <div className="relative flex items-center bg-gray-100 rounded-full px-3 py-2 w-full max-w-[400px]">
          <svg
          ...
          <input
            type="text"
            placeholder="Search"
            className="bg-transparent outline-none text-sm text-gray-900 placeholder-gray-500 w-full pl-8"
            disabled
          />
        </div>
